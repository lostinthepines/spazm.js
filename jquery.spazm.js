...
(function( $ ){
  ...
  var methods = {
     ...
     zoom : function (zoom_level,x,y) {
    	 return this.each(function(){
    		 ...
    		 console.log('zooming to level ' + zoom_level + ' num levels ' + data.num_zoom_levels);
    		  ...
    		  if(typeof x != "undefined" && typeof y != "undefined") {
    			  console.log('zooming to coords ' + x + ' ' + y);
  ...
  var loadTilesForLevel = function(elem) {
	  ...
	  var x = parseInt(container.css('left'));
	  var y = parseInt(container.css('top'));
  ...
  var getLevelSizes = function(numLevels, minWidth, minHeight, maxWidth, maxHeight) {
	  ...
	  var dx =  parseInt((maxWidth - minWidth) / numLevels);
	  var dy =  parseInt((maxHeight - minHeight) / numLevels);
